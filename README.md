...
The SBOM is generated by the [GitHub Actions workflow](https://github.com/noppanut15/depthviz/blob/main/.github/workflows/deploy.yaml) using the [cyclonedx-python](https://github.com/CycloneDX/cyclonedx-python) library. You can download the latest **SBOM** from the [release artifacts](https://github.com/noppanut15/depthviz/releases).
