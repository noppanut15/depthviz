...
| `--depth-mode`                                                                                                                                         | `raw`, <br/>`zero-based`                                           | `raw`                                                       | Depth display mode. `raw` displays the raw depth values from the dive log. `zero-based` sets the starting depth & ending depth to 0m. |
